...
- (void)dealloc
{
    ...
    //
    // We keep strong reference to scrollView to make unregistering proccess become possible
    // So do always nil scroll view
    //
    self.scrollView = nil;
}
